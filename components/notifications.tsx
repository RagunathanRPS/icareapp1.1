...
const notifications = [
  {
    id: 1,
    title: "New Feature",
    message: "2FA Authentication Activated to your Account",
    date: "2025-02-15",
    icon: Info,
    color: "text-blue-500",
  },
  ...
  },
  {
    ...
    message: "Fill all required details in the setting / profile page.",
    date: "2025-02-13",
    icon: CreditCard,
    color: "text-red-500",
  },
  ...
  },
  {
    id: 5,
    title: "New Offer",
    message: "You're eligible for a new higher Account Accebility!",
    date: "2025-03-14",
    icon: Gift,
